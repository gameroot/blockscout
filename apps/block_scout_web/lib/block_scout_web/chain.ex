defmodule BlockScoutWeb.Chain do
  ...
  def paging_options(%{"token_name" => name, "token_type" => type}),
    do: [paging_options: %{@default_paging_options | key: {name, type}}]
  ...
  defp paging_params(%Token{name: name, type: type}),
    do: %{"token_name" => name, "token_type" => type}
